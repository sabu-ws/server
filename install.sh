...
# VARS
DATA_MOUNTPOINT="/tmp/"
PACKAGES_PART_1="dirmngr apt-transport-https lsb-release ca-certificates gnupg nodejs nginx openssl python3 python3-pip python3-venv postgresql nftables rsyslog gnupg postgresql-common wget ipcalc clamav yara"
